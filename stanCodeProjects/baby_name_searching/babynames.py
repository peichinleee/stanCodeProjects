...
def add_data_for_name(name_data, year, rank, name):
    ...
    if name not in name_data:
        # name is not in name_data, add to dict: name_data
        name_data[name] = {year: rank}
    elif year in name_data[name]:
        # name is in name_data but year exist, keep the higher rank
        if int(rank) < int(name_data[name][year]):
            name_data[name][year] = rank
    else:
        # name is in name_data but year not exist, add to dict: name_data[name]
        name_data[name][year] = rank
